...
export default {
    ...
    data(){
        return{
            ...
            characterOptions: [
                { name: '--', code: 'empty' },
                { name: 'Anererak', code: 'Anererak' },
                { name: 'Angstigoth', code: 'Angstigoth' },
                { name: 'Baron Hex', code: 'Baron Hex' },
                { name: 'Belladonna', code: 'Belladonna' },
                { name: 'The Brothers Wise', code: 'The Brothers Wise' },
                { name: 'Calabeza', code: 'Calabeza' },
                { name: 'Cerebellus', code: 'Cerebellus' },
                { name: 'Chase', code: 'Chase' },
                { name: 'Cleopatra', code: 'Cleopatra' },
                { name: 'Doc Scarecrow', code: 'Doc Scarecrow' },
                { name: 'Dr. Timebender', code: 'Dr. Timebender' },
                { name: 'Draculord', code: 'Draculord' },
                { name: 'Eclipse', code: 'Eclipse' },
                { name: 'Elicon', code: 'Elicon' },
                { name: 'Explodo', code: 'Explodo' },
                { name: 'Gorgona', code: 'Gorgona' },
                { name: 'Greg', code: 'Greg' },
                { name: 'Gregore', code: 'Gregore' },
                { name: 'Hellcow', code: 'Hellcow' },
                { name: 'Jarin', code: 'Jarin' },
                { name: "Kaw'nee", code: "Kaw'nee" },
                { name: 'Kazanna', code: 'Kazanna' },
                { name: 'Killa', code: 'Killa' },
                { name: 'King Croak', code: 'King Croak' },
                { name: 'Kirax', code: 'Kirax' },
                { name: 'Lamia', code: 'Lamia' },
                { name: 'Mirrax', code: 'Mirrax' },
                { name: 'Mobi', code: 'Mobi' },
                { name: 'Nicolius', code: 'Nicolius' },
                { name: 'Oculus', code: 'Oculus' },
                { name: 'Porkus', code: 'Porkus' },
                { name: 'Ravenus', code: 'Ravenus' },
                { name: 'Robobo', code: 'Robobo' },
                { name: 'Scythe', code: 'Scythe' },
                { name: 'Seducia', code: 'Seducia' },
                { name: 'Shellda', code: 'Shellda' },
                { name: 'Smoake', code: 'Smoake' },
                { name: 'The Cleric Killer', code: 'The Cleric Killer' },
